// PAR2010.vso: parallax, sun + specular half vector, projected shadow, fog. Stock-equivalent output layout.
...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    OUT.Light0Half = normalize(mul(TanSpaceProj, normalize(eye + LightDirection[0].xyz)));
