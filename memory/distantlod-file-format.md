...
metadata: 
  node_type: memory
  type: reference
  originSessionId: dba6b559-c4af-4462-8104-6dcd1b99fd1f
  modified: 2026-07-26T16:56:06.440Z
---

Decoded 2026-07-26 by extracting `distantlod\tamriel_0_0.lod` / `tamriel_-34_-10.lod` from
`MergedLOD - LODs.bsa` and `Oblivion - Meshes.bsa` (BSA parser + dumper left in the session
scratchpad; format is trivial to re-derive).
...
always ~0.97 — in every record of every file checked. The distant-LOD vertex shaders
(`Shaders/ExtraShaders/DISTLOD2002.vso.hlsl`, `DISTLOD2003.vso.hlsl`) show why:
...
object/tree instances are therefore **snapped to a 1-unit grid**, and scale is quantized to 0.01.
